	...
	<div class="container">
		...
		<div id="img-des">
			...
			<div class="product-description">
				...
				<h3>
					Price: ₹<%=product.getPrice()%></h3>
				<h4>
					Availbality:<%=product.isAvailability().equalsIgnoreCase("IN_Stock") ? "Available" : "Unavailable"%></h4>
			</div>
		</div>
		...
		<form action="<%=request.getContextPath()%>/controller" method="post">
			<input type="hidden" name="command" value="productPage"> <input
				type="hidden" name="add" value="addcart"> <input
